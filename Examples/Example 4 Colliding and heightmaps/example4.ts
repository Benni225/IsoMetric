...
var App: IsoMetric, firstLayer: IsoLayer, unpassableTileNumber = 1;
window.onload = function () {
    ...
    App.tileSets.load().then(function () {
        ...
        firstLayer.sprites.load().then(() => gameExample4());
    });
}
// The gameloop
function gameExample4() {
    ...
    requestAnimationFrame(() => gameExample4());
};

function checkCollisionOnHeightMap(sprite: IsoSprite) {
